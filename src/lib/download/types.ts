...
export const DOWNLOAD_CACHE_NAME = 'cineharbor-vod-download-v1';
export const DOWNLOAD_STORE_KEY = 'cineharbor-download-store-v1';
export const DOWNLOAD_RESOURCE_DB_NAME = 'cineharbor-download-db-v1';
