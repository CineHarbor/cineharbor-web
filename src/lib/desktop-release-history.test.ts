...
describe('desktop release history helpers', () => {
  ...
  it('finds the updater manifest asset url', () => {
    ...
    expect(
      findDesktopReleaseManifestUrl([
        {
          name: 'CineHarbor.Desktop_200.0.0_x64-setup.exe',
  ...
  it('builds a local fallback release list from desktop changelog entries', () => {
    ...
    expect(
      ...
      prerelease: true,
      htmlUrl:
        'https://github.com/jaytantech3000/CineHarbor/releases/tag/desktop-v200.0.1-beta.8',
      manifestUrl:
        'https://proxy.example.com/api/desktop/updater/latest?repo=jaytantech3000%2FCineHarbor&tag=desktop-v200.0.1-beta.8',
    });
