...
export const LOCAL_PLAY_RECORDS_STORAGE_KEY = 'cineharbor_play_records';
export const LOCAL_FAVORITES_STORAGE_KEY = 'cineharbor_favorites';
export const LOCAL_FOLLOWS_STORAGE_KEY = 'cineharbor_follows';
export const LOCAL_SEARCH_HISTORY_STORAGE_KEY = 'cineharbor_search_history';
export const LOCAL_SKIP_CONFIGS_STORAGE_KEY = 'cineharbor_skip_configs';
