...
export const DESKTOP_RUNTIME_UPDATED_EVENT = 'cineharbor:runtime-config-updated';
export const DESKTOP_RUNTIME_REFRESH_EVENT = 'cineharbor:refresh-runtime-config';
