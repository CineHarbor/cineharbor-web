...
describe('desktop release notes helpers', () => {
  it('extracts the compare url from full changelog notes', () => {
    ...
    expect(getDesktopReleaseCompareApiUrl(compareUrl)).toBe(
      'https://api.github.com/repos/jaytantech3000/CineHarbor/compare/desktop-v200.0.0-beta.15...desktop-v200.0.0-beta.16'
    );
  });
...
`,
  ...
  it('keeps current and unknown commit summaries fully localized in Chinese', () => {
    const compareUrl =
      'https://github.com/jaytantech3000/CineHarbor/compare/desktop-v200.0.1-beta.45...desktop-v200.0.1-beta.46';
