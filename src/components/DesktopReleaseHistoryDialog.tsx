...
const FAVORITE_RELEASES_STORAGE_KEY =
  'cineharbor:desktop-release-history:favorites';
  ...
  const copy =
    locale === 'en'
      ? {
          ...
          rollbackDialogMessage: `CineHarbor will roll back to v${version}, install it quietly, and restart automatically.`,
          switchDialogMessage: `CineHarbor will switch to v${version}, install it quietly, and restart automatically.`,
