...
describe('DownloadedContentDialog', () => {
  ...
  it('moves the adult filtering notice into download settings', async () => {
    ...
    render(
      <SiteProvider siteName='CineHarbor' adultContentFilterEnabled>
        <DownloadsClient />
      </SiteProvider>
    );
  ...
  it('shows local desktop download paths in settings when the desktop runtime is enabled', async () => {
    ...
    mockGetDesktopDownloadRuntimeStorageInfo.mockResolvedValue({
      ...
      rootDir: 'C:\\Users\\jay\\.cineharbor-desktop\\download-runtime',
      cacheBodyDir:
        'C:\\Users\\jay\\.cineharbor-desktop\\download-runtime\\cache-body',
      cacheMetaDir:
        'C:\\Users\\jay\\.cineharbor-desktop\\download-runtime\\cache-meta',
      resourceIndexDir:
        'C:\\Users\\jay\\.cineharbor-desktop\\download-runtime\\resource-index',
      sqlitePath: 'C:\\Users\\jay\\.cineharbor-desktop\\cineharbor-desktop.sqlite3',
    });

    render(
      <SiteProvider siteName='CineHarbor'>
        <DownloadsClient />
      </SiteProvider>
    );
    ...
    expect(
      await screen.findByText(
        'C:\\Users\\jay\\.cineharbor-desktop\\download-runtime'
      )
    ).toBeInTheDocument();
